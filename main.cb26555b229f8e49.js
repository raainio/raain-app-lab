...
class ProfileService {
      ...
      try {
        ...
        while (hasNext) {
          ...
          for (const r of resp.data.radars) {
            radars.push(new raain_model__WEBPACK_IMPORTED_MODULE_1__.RadarNode(r));
          }
          hasNext = resp.data.pagination?.hasNext ?? false;
          page++;
        }
      } catch (e) {
  ...
  getLonelyRadars(rains) {
    ...
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        const allRadars = yield _this15.getRadars();
        const lonelyRadars = [];
    ...
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        return {
          ...
          timeStepInMinutes: response.data.timeStepInMinutes?.length ? response.data.timeStepInMinutes : [5, 10, 15, 30, 60]
        };
      } catch (e) {
...
class RaainConfigurationComponent {
  ...
  create() {
    ...
    this.created = true;
    let inputs = new raain_ui__WEBPACK_IMPORTED_MODULE_1__.ConfigurationElementInput(this.points, this.minPoint, this.maxPoint, false, [], this.onDrag, this.readonly);
    if (this.logStyle) {
  ...
  delete() {
    var _this2 = this;
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this2.createTimer) {
        clearTimeout(_this2.createTimer);
        _this2.createTimer = null;
      }
  ...
  change(changes) {
    ...
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this3.configurationElement?.chart && changes.points && Object.keys(changes).length === 1) {
        const chart = _this3.configurationElement.chart;
        chart.data.datasets.forEach(ds => {
          ds.data = _this3.points;
        });
        chart.update('none');
        return;
      }
    ...
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const uiCompares = comparePerDate.compareTimeline.map(c => {
        ...
        return {
          ...
          comparePointsMax: new _xytype__WEBPACK_IMPORTED_MODULE_3__.XYType(Math.max(c.maxValue * 1.2, 1), Math.max(c.maxValue * 1.2, 1)),
  ...
  refreshGlobalCompareQuality(_x, _x2, _x3) {
    ...
    return (0,_opt_atlassian_pipelines_agent_build_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (targetsOrdered, period, withCompareDuplicate, provider = 'Raain', timeStepInMinutes = 5, timeStepMode = 'eq') {
      try {
        ...
        const maxValue = Math.max(_this2.buildCompares.compareCumulative.maxValue * 1.2, 1);
...
//# sourceMappingURL=main.cb26555b229f8e49.js.map